  ...
  input_schema: {
    ...
    properties: {
      ...
      imagePrompt: {
        type: "string",
        description:
          "Beeldende beschrijving voor een vrolijke, niet-enge kinderboek-illustratie van ÉÉN stilstaand moment dat de GEKOZEN actie zichtbaar maakt (niet opnieuw dezelfde groepspose). Wie doet wat, waar staat iedereen, wat is er anders in beeld. Dit is de tekening ná het lezen, dus die moet bij de keuze én de laatste bladzijde passen. VERBODEN: andere kleding, kleuren of kapsel dan het vaste uiterlijk noemen. VERBODEN: extra onbenoemde figuren verzinnen. VERBODEN: twee momenten samenvoegen. VERBODEN: opnieuw dezelfde huddle/grot-pose als het vorige plaatje. Het uiterlijk van held en wereld voegt de code zelf toe — focus op de actie.",
      },
      isFinale: {
        type: "boolean",
